...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'white_signup2014', 'pair_num_fix', 'pair_num')

        # Deleting field 'Signup2014.team_num_fix'
        db.rename_column(u'white_signup2014', 'team_num_fix', 'team_num')

    def backwards(self, orm):
        # Deleting field 'Signup2014.pair_num'
        db.rename_column(u'white_signup2014', 'pair_num', 'pair_num_fix')

        # Deleting field 'Signup2014.team_num'
        db.rename_column(u'white_signup2014', 'team_num', 'team_num_fix')
